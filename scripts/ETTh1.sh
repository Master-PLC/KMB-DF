...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) alpha=0.1 lr=0.001 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=5 gamma=8 kernel_type=exp solver_type=kdiff reg=0.001 C=0.01 normed=1 joint_forecast=1 l2_reg=1e-4;;
        192) alpha=0.4 lr=0.00002 lradj=TST batch_size=24 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=1 gamma=2 kernel_type=exp solver_type=kdiff reg=0.001 C=0.001 normed=1 joint_forecast=1 l2_reg=1e-5;;
        336) alpha=0.1 lr=0.005 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=6 gamma=3 kernel_type=exp solver_type=kdiff reg=0.001 C=0.01 normed=1 joint_forecast=1 l2_reg=5e-5;;
        720) alpha=0.7 lr=0.0005 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=3 gamma=3 kernel_type=exp solver_type=kdiff reg=0.001 C=0.001 normed=1 joint_forecast=1 l2_reg=5e-5;;
    esac
