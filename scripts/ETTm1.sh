...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) alpha=0.9 lr=0.0002 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=6 gamma=0.1 kernel_type=exp solver_type=kdiff reg=0.001 C=0.005 normed=1 joint_forecast=1 l2_reg=1e-5;;
        192) alpha=0.3 lr=0.01 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=1 gamma=0.02 kernel_type=exp solver_type=kdiff reg=0.001 C=0.01 normed=1 joint_forecast=1 l2_reg=1e-5;;
        336) alpha=0.02 lr=0.0002 lradj=type3 batch_size=16 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=5 gamma=0.02 kernel_type=exp solver_type=kdiff reg=0.001 C=0.01 normed=1 joint_forecast=1 l2_reg=0.0;;
        720) alpha=0.8 lr=0.0005 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=1 gamma=0.05 kernel_type=exp solver_type=kdiff reg=0.001 C=0.01 normed=1 joint_forecast=1 l2_reg=0.0;;
    esac
