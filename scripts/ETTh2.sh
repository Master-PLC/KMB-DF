...
for pl in ${pl_list[@]}; do
    ...
    case $pl in
        96) alpha=0.8 lr=0.0004 lradj=type3 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=3 gamma=4 kernel_type=exp solver_type=kdiff reg=0.001 C=0.0001 normed=1 joint_forecast=1 l2_reg=0.0;;
        192) alpha=0.85 lr=0.0001 lradj=TST batch_size=24 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=6 gamma=4 kernel_type=exp solver_type=kdiff reg=0.001 C=0.005 normed=1 joint_forecast=1 l2_reg=0.0;;
        336) alpha=0.1 lr=0.0002 lradj=constant batch_size=128 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=1 gamma=4 kernel_type=exp solver_type=kdiff reg=0.001 C=0.001 normed=1 joint_forecast=1 l2_reg=0.0;;
        720) alpha=0.6 lr=0.0005 lradj=type1 batch_size=32 inner_lr=0.0005 inner_optim=adam inner_step=1 auxi_type=akb auxi_loss=AKB J=1 gamma=4 kernel_type=exp solver_type=kdiff reg=0.001 C=0.05 normed=1 joint_forecast=1 l2_reg=0.0;;
    esac
